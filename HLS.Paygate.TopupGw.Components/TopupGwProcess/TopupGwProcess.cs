...
public partial class TopupGwProcess : ITopupGwProcess
{
    ...
    public async Task<NewMessageReponseBase<ResponseProvider>> TopupRequest(GateTopupRequest request)
    {
        try
        {
    ...
    private async Task CheckAutoClose(NewMessageReponseBase<ResponseProvider> response,
