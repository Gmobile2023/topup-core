...
namespace HLS.Paygate.TopupGw.Components.Connectors.VNPTPay;
...
public class VnptPayConnector : GatewayConnectorBase
{
        ...
        ProviderInfoDto providerInfo)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                if (reResult.ReponseCode is ResponseCodeConst.ResponseCode_Failed
                ...
                else
                {
                    ...
                    responseMessage.ResponseMessage =
                        reResult != null ? reResult.ReponseName : "Giao dịch chưa có kết quả";
    ...
    public override async Task<NewMessageReponseBase<InvoiceResultDto>> QueryAsync(
    ...
    public override async Task<MessageResponseBase> CardGetByBatchAsync(CardRequestLogDto cardRequestLog)
    {
        ...
        else
        {
                    ...
                    or ResponseCodeConst.ResponseCode_00)
            {
                responseMessage.ResponseCode = ResponseCodeConst.Error;
                responseMessage.ResponseMessage =
                    reResult != null ? reResult.ReponseName : "Giao dịch không thành công từ nhà cung cấp";
