...
namespace HLS.Paygate.TopupGw.Components.Connectors.Finviet
{
    public class FinVietConnector : GatewayConnectorBase
    {
            ...
            ProviderInfoDto providerInfo)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    responseMessage.ResponseCode = reResult != null ? reResult.ReponseCode : ResponseCodeConst.ResponseCode_WaitForResult;
                    responseMessage.ResponseMessage = reResult != null ? reResult.ReponseName : "Giao dịch chưa có kết quả.";
                    topupRequestLog.ModifiedDate = DateTime.Now;
                }
        ...
        public override async Task<NewMessageReponseBase<InvoiceResultDto>> QueryAsync(PayBillRequestLogDto payBillRequestLog)
        {
            ...
            else
            {
                ...
                responseMessage.ResponseStatus.ErrorCode = reResult != null ? reResult.ReponseCode : ResponseCodeConst.ResponseCode_WaitForResult;
                responseMessage.ResponseStatus.Message = reResult != null ? reResult.ReponseName : "Giao dịch đang chờ kết quả. Vui lòng liên hệ CSKH để được hỗ trợ";
            }
