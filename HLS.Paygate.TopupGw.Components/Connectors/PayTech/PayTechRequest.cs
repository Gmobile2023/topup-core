namespace HLS.Paygate.TopupGw.Components.Connectors.PayTech;
...
public class DataInput
{
    ...
    public Contacts.Dtos.TopupRequestLogDto Topup { get; set; }

    public Contacts.Dtos.PayBillRequestLogDto PayBill { get; set; }

    public Contacts.Dtos.CardRequestLogDto Card { get; set; }
