            ...
            else
            {
                ...
                if (new[] { "FAI", "BUS", "INV" }.Contains(result.code))
                {
                    responseMessage.ResponseStatus.ErrorCode =
                        reResult != null ? reResult.ReponseCode : ResponseCodeConst.Error;
                    responseMessage.ResponseStatus.Message = reResult != null ? reResult.ReponseName : result.message;
                }
                else
                {
