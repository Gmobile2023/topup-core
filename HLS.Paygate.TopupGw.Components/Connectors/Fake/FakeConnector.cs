...
namespace HLS.Paygate.TopupGw.Components.Connectors.Fake;
...
public class FakeConnector : IGatewayConnector
{
    ...
    public Task<NewMessageReponseBase<InvoiceResultDto>> QueryAsync(PayBillRequestLogDto payBillRequestLog)
    {
        ...
        {
            "091231232" => new NewMessageReponseBase<InvoiceResultDto>
            {
                ResponseStatus = new ResponseStatusApi(ResponseCodeConst.ResponseCode_ErrorProvider,
                    "Giao dịch lỗi từ NCC"),
            },
            "091231231" => new NewMessageReponseBase<InvoiceResultDto>
            {
            ...
            "091231230" => new NewMessageReponseBase<InvoiceResultDto>
            {
                ResponseStatus = new ResponseStatusApi(ResponseCodeConst.Success, "Giao dịch thành công"),
                Results = new InvoiceResultDto
                {
            ...
            _ => new NewMessageReponseBase<InvoiceResultDto>
            {
                ResponseStatus = new ResponseStatusApi(ResponseCodeConst.Success, "Giao dịch thành công"),
                Results = new InvoiceResultDto
                {
