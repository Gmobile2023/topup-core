...
[Route("/api/v1/common/notification/getall", "GET")]
...
[Route("/api/v1/common/notification/get_last", "GET")]
...
[Route("/api/v1/common/notification/set_all_as_read", "POST")]
public class SetAllNotificationsAsReadRequest
{
    public string AccountCode { get; set; }
}

[Route("/api/v1/common/notification/set_as_read", "POST")]
...
[Route("/api/v1/common/notification/delete", "DELETE")]
...
[Route("/api/v1/common/notification/subscribe", "POST")]
...
[Route("/api/v1/common/notification/un_subscribe", "POST")]
...
[Route("/api/v1/common/notification/un_subscribe_account", "POST")]
...
[Route("/api/v1/common/notification/get", "GET")]
...
[Route("/api/v1/common/notification/send", "POST")]
