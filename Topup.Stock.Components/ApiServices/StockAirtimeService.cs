...
using Topup.Gw.Model.Commands.Stock;
using Topup.Gw.Model.Events.Stock;
using Topup.Shared;
...
namespace Topup.Stock.Components.ApiServices;
...
public class StockAirtimeService : Service
{
    ...
    private readonly IStockAirtimeBusinessServices _stockAirtimeService;

    public StockAirtimeService(ICardService cardService,
        IStockAirtimeBusinessServices stockAirtimeService,
