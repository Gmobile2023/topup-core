...
public class WorkerTopupRequest : IPost, IReturn<NewMessageResponseBase<WorkerResult>>
{
    ...
    [DataMember(Order = 9)] public string ServiceCode { get; set; }
    [DataMember(Order = 10)]  public string ProductCode { get; set; }

    [DataMember(Order = 11)] public DateTime RequestDate { get; set; }

    [DataMember(Order = 12)] public bool IsCheckReceiverType { get; set; }
    [DataMember(Order = 13)] public string PartnerCode { get; set; }
