...
{
    [BsonRequired] public string Etag { get; set; }

    [BsonRequired] public string HostName { get; set; }

    [BsonRequired] public string SiloAddress { get; set; }

    [BsonRequired] public string SiloName { get; set; }

    [BsonRequired] public string RoleName { get; set; }

    [BsonIgnoreIfNull] public string StatusText { get; set; }

    [BsonRequired] public string IAmAliveTime { get; set; }

    [BsonRequired] public string StartTime { get; set; }

    [BsonRequired] public int ProxyPort { get; set; }

    [BsonRequired] public int UpdateZone { get; set; }

    [BsonRequired] public int FaultZone { get; set; }

    [BsonRequired] public int Status { get; set; }

    [BsonRequired] public List<MongoSuspectTime> SuspectTimes { get; set; }

    [BsonIgnoreIfDefault] public DateTime Timestamp { get; set; }
    ...
    public Uri ToGatewayUri()
    {
        ...
        return SiloAddressClass.New(new IPEndPoint(siloAddress.Endpoint.Address, ProxyPort), siloAddress.Generation)
            .ToGatewayUri();
    }
}