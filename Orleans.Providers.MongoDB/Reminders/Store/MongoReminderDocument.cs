...
{
    [BsonRepresentation(BsonType.String)] public string Id { get; set; }

    [BsonRequired] public string ServiceId { get; set; }

    [BsonRequired] public string GrainId { get; set; }

    [BsonRequired] public string ReminderName { get; set; }

    [BsonRequired] public string Etag { get; set; }

    [BsonRequired] public TimeSpan Period { get; set; }

    [BsonRequired] public long GrainHash { get; set; }

    [BsonRequired] public bool IsDeleted { get; set; }
