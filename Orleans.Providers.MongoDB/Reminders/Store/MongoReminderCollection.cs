...
{
    private static readonly FindOneAndUpdateOptions<MongoReminderDocument> UpsertReplace = new() {IsUpsert = true};
    ...
    public async Task<bool> RemoveRow(GrainReference grainRef, string reminderName, string eTag)
    {
        ...
        try
        {
            var existingDocument =
                await Collection.FindOneAndUpdateAsync<MongoReminderDocument, MongoReminderDocument>(
                    x => x.Id == id && x.Etag == eTag,
