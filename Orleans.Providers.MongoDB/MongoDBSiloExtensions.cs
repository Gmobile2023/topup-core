...
public static class MongoDBSiloExtensions
{
    ...
    public static IServiceCollection AddMongoDBGrainStorageAsDefault(this IServiceCollection services,
        Action<MongoDBGrainStorageOptions> configureOptions)
    {
        return services.AddMongoDBGrainStorage(ProviderConstants.DEFAULT_STORAGE_PROVIDER_NAME,
        ...
        Action<OptionsBuilder<MongoDBGrainStorageOptions>> configureOptions = null)
    {
        ...
        services.TryAddSingleton<IGrainStateSerializer>(sp =>
            new JsonGrainStateSerializer(sp.GetService<ITypeResolver>(), sp.GetService<IGrainFactory>(),
                sp.GetService<IOptionsMonitor<MongoDBGrainStorageOptions>>().Get(name)));
        ...
        services.AddSingletonNamedService(name,
