...
public class StockCardImportApiRequest : IPost, IReturn<NewMessageReponseBase<List<NewMessageReponseBase<string>>>>
{
...
public class StockCardApiCheckTransRequest : IPost, IReturn<NewMessageReponseBase<string>>
{
    [DataMember(Order = 1)][Required] public string Provider { get; set; }
