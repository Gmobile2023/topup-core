...
public class PayBatchService : IPayBatchService
{
    ...
    public async Task<NewMessageReponseBase<BatchRequestDto>> PayBatchProcess(PayBatchRequest request)
    {
        //_logger.LogInformation("{Partner} PayBatchProcess: {Request}", request.PartnerCode, request.ToJson());
        var returnMessage = new NewMessageReponseBase<BatchRequestDto>();
        ...
        catch (Exception ex)
        {
            ...
            return new NewMessageReponseBase<BatchRequestDto>
            {
        ...
        try
        {
            ...
            foreach (var item in dto.Items)
            {
                    ...
                    && batchDetail.Status == SaleRequestStatus.Init)
                {
                    ...
                    var pinCodeResult = new NewMessageReponseBase<List<CardRequestResponseDto>>();
                    var result = new NewMessageReponseBase<WorkerResult>();
                    ...
                    else if (batch.SaleRequestType == SaleRequestType.PinCode)
                    {
                        ...
                        result = new NewMessageReponseBase<WorkerResult>
                        {
