...
public class ValidateServiceBase : IValidateServiceBase
{
    ...
    public async Task<NewMessageReponseBase<PartnerConfigDto>> VerifyPartnerAsync(ValidateRequestDto requestDto)
    {
        try
        {
            var response = new NewMessageReponseBase<PartnerConfigDto>();
