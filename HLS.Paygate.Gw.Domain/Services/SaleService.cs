...
//
        ...
        public async Task<NewMessageReponseBase<BalanceResponse>> RefundTransaction(string transCode)
        {
            try
            {
                        ...
                        saleRequest.Status == SaleRequestStatus.InProcessing)
                    {
                            ...
                            !string.IsNullOrEmpty(saleRequest.PaymentTransCode))
                        {
                            ...
                            if (refundResponse.ResponseStatus.ErrorCode != ResponseCodeConst.Success)
                                return new NewMessageReponseBase<BalanceResponse>
                                {
        ...
        /// <returns></returns>
        public async Task<NewMessageReponseBase<string>> CardImportProvider(CardImportProviderRequest cardSaleRequest)
        {
            _logger.LogInformation("CardImportProvider {Request}", cardSaleRequest.ToJson());
            var reponse = new NewMessageReponseBase<string>();
            ...
            {
                reponse = new NewMessageReponseBase<string>()
                {
            ...
            if (sendCard.ResponseStatus.ErrorCode == ResponseCodeConst.Success)
            {
                ...
                var items = sendCard.Results.ConvertTo<List<NewMessageReponseBase<string>>>();
