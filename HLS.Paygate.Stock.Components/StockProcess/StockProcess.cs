...
public class StockProcess : IStockProcess
{
    ...
    public async Task<NewMessageReponseBase<object>> ExchangeRequest(StockCardExchangeRequest request)
    {
        try
        {
    ...
    public async Task<NewMessageReponseBase<object>> InportRequest(StockCardImportRequest request)
    {
        try
        {
    ...
    public async Task<NewMessageReponseBase<int>> CheckInventoryRequest(StockCardCheckInventoryRequest request)
    {
        try
        {
            ...
            return new NewMessageReponseBase<int>
            {
                Results = inventory,
    ...
    public async Task<NewMessageReponseBase<List<CardRequestResponseDto>>> ExportCardToSaleRequest(
    ...
    public async Task<NewMessageReponseBase<string>> InportListRequest(StockCardImportListRequest request)
    {
        try
        {
    ...
    public async Task<NewMessageReponseBase<List<NewMessageReponseBase<string>>>> CardImportStockFromProvider(
        StockCardImportApiRequest request)
    {
        var listResponseItem = new List<NewMessageReponseBase<string>>();
        ...
        try
        {
            ...
            foreach (var item in batch.StockBatchItems)
            {
                ...
                var responseData = new NewMessageReponseBase<object>
                {
                    ResponseStatus = new ResponseStatusApi(ResponseCodeConst.Error)
                };
                while (quantity > 0)
                {
                    ...
                    if (responseData.ResponseStatus.ErrorCode != ResponseCodeConst.Success)
                        responseData = new NewMessageReponseBase<object>()
                        {
                ...
                listResponseItem.Add(new NewMessageReponseBase<string>
                {
    ...
    private async Task<NewMessageReponseBase<List<CardProviderItemWaitDto>>> CardsApiImportProcessAsync(StockBatchDto batch,
        StockBatchItemDto item, int quantity, int index = 0)
    {
        try
        {
            ...
            return new NewMessageReponseBase<List<CardProviderItemWaitDto>>
            {
                ResponseStatus = response.ResponseStatus,
                Results = lstTemp
            };
    ...
    /// <returns></returns>
    private async Task<NewMessageReponseBase<string>> CheckUpdateCardProviderItemRetry(string provider, string batchCode, CardProviderItemWaitDto item, DateTime? expiredDate, bool isSyncCard, bool retry = false)
    {
        try
        {
    ...
    /// <returns></returns>
    public async Task<NewMessageReponseBase<string>> CheckTransCardFromProvider(StockCardApiCheckTransRequest request)
    {
