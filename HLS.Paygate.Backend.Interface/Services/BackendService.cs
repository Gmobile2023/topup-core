...
namespace HLS.Paygate.Backend.Interface.Services
{
    ...
    public partial class BackendService : Service
    {
        ...
        public async Task<NewMessageReponseBase<string>> PostAsync(UpdateCardCodeRequest request)
        {
            string transCode = request.TransCode;
            var reponseMage = new NewMessageReponseBase<string>()
            {
        ...
        private async Task<NewMessageReponseBase<string>> SendOffsetTopup(string transCode)
        {
            try
            {
                var reponseMage = new NewMessageReponseBase<string>()
