...
namespace HLS.Paygate.Worker.Components.WorkerProcess
{
    ...
    {
        public async Task<NewMessageReponseBase<WorkerResult>> PayBillRequest(WorkerPayBillRequest request)
        {
            try
            {
        ...
        private async Task<NewMessageReponseBase<ResponseProvider>> CallPayBillGate(GatePayBillRequest paybill)
        {
            try
            {
        ...
        private async Task<(NewMessageReponseBase<ResponseProvider>, TransactionInfoDto)> CallPayBillPriority(
