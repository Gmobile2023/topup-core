...
public class ProviderInfoRequest : IPost, IReturn<NewMessageReponseBase<string>>
{
...
public class ProviderInfoGet : IGet, IReturn<NewMessageReponseBase<string>>
{
    public string ProviderCode { get; set; }
}

[Route("/api/v1/provider_response", "POST")]
public class CreateProviderReponse : IPost, IReturn<NewMessageReponseBase<string>>
{
...
public class UpdateProviderReponse : IPut, IReturn<NewMessageReponseBase<string>>
{
    public string Provider { get; set; }
    public string ReponseCode { get; set; }
    public string ReponseName { get; set; }
...
public class DeleteProviderReponse : IDelete, IReturn<NewMessageReponseBase<string>>
{
    public string Provider { get; set; }
    public string Code { get; set; }
}
...
public class GetProviderReponse : IGet, IReturn<NewMessageReponseBase<ProviderReponseDto>>
{
    public string Provider { get; set; }
    public string Code { get; set; }
}
...
public class ProviderSalePriceInfoRequest : IPost, IReturn<NewMessageReponseBase<string>>
{
    public string ProviderCode { get; set; }
...
public class ProviderSalePriceInfoGet : IGet, IReturn<NewMessageReponseBase<string>>
{
    public string ProviderCode { get; set; }
    public string ProviderType { get; set; }
    public string TopupType { get; set; }
